...
use crate::tools::handlers::output_image_detail_for_turn;
...
fn emitted_image_content_item(
    ...
    FunctionCallOutputContentItem::InputImage {
        image_url,
        detail: detail.or_else(|| output_image_detail_for_turn(turn)),
    }
}
...
mod tests {
    ...
    async fn emitted_image_content_item_uses_turn_original_detail_when_enabled() {
        ...
        turn.model_info.slug = "gpt-5.3-codex".to_string();
